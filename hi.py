...
; Left column of H (x=5, y=5..10)
write a7 5       ; a7 = x for left column
write a8 5       ; a8 = y start
disp a7 a8       ; plot (5,5)
++ a8 a8         ; y=6
disp a7 a8       ; plot (5,6)
++ a8 a8         ; y=7
...
disp a7 a8       ; plot (5,9)
++ a8 a8         ; y=10
disp a7 a8       ; plot (5,10)

; Crossbar of H (x=6..8, y=7)
write a9 7       ; a9 = fixed y=7 for crossbar
write a7 6       ; a7 = x=6
disp a7 a9       ; plot (6,7)
++ a7 a7         ; x=7
disp a7 a9       ; plot (7,7)
...
; Right column of H (x=9, y=5..10)
write a7 9       ; a7 = x for right column
write a9 5       ; a9 = y start
disp a7 a9       ; plot (9,5)
++ a9 a9         ; y=6
disp a7 a9       ; plot (9,6)
++ a9 a9         ; y=7
...
disp a7 a9       ; plot (9,9)
++ a9 a9         ; y=10
disp a7 a9       ; plot (9,10)

; -- Draw the letter I --

; Vertical bar of I (x=12, y=5..10)
write a7 12      ; a7 = x=12
write a9 5       ; a9 = y start
disp a7 a9       ; (12,5)
++ a9 a9         ; y=6
